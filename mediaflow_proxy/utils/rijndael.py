...
class Rijndael(object):
    ...
    def encrypt(self, plaintext):
        ...
        if len(plaintext) != self.block_size:
            raise ValueError("wrong block length, expected {0} got {1}".format(self.block_size, len(plaintext)))
        Ke = self.Ke
    ...
    def decrypt(self, ciphertext):
        ...
        if len(ciphertext) != self.block_size:
            raise ValueError("wrong block length, expected {0} got {1}".format(self.block_size, len(ciphertext)))
        Kd = self.Kd
